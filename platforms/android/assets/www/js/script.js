...
_page.createSchedule = function () {
  Schedule = _data.Schedule || _data.getSchedule();
  ...
  for (var i = 0; i < Schedule.length; i++) {
    ...
    game1 = document.createElement('tr');
    game2 = document.createElement('tr');
    vs = document.createElement('td');
    vs.textContent = "VS";
    
    
    team1 = document.createElement('td');
    team1.textContent = Schedule[i].teams[0];
    team2 = document.createElement('td');
    ...
    team3 = document.createElement('td');
    team3.textContent = Schedule[i].teams[2];
    team4 = document.createElement('td');
...
_page.createStandings = function () {
  Standings = _data.Standings || _data.getStandings();
...
_data.getStandings = function () {
  ...
  for (i = 0; i < _data.Scores.length; i++) {
    for (var j = 0; j < _data.Scores[i].games.length; j++) {
      home = _data.Scores[i].games[j].home;
      home_score = _data.Scores[i].games[j].home_score;
      away = _data.Scores[i].games[j].away;
      away_score = _data.Scores[i].games[j].away_score;
  ...
  // Sort
  Standings.sort(function(a, b) { b.score - a.score});
...
_data.getSchedule = function () {
  ...
  for (var i = 0; i < _data.Scores.length; i++) {
    ...
    for (var j = 0; j < _data.Scores[i].games.length; j++) {
      home = _teams.getName(_data.Scores[i].games[j].home);
      away = _teams.getName(_data.Scores[i].games[j].away);
...
_page.init = function () {
  ...
  // Setup listeners
  _page.btnSchedule.addEventListener("click", () => _page.changeTab(0), false);
  _page.btnStandings.addEventListener("click", () => _page.changeTab(1), false);
  _page.btnrefresh.addEventListener("click", () => _data.reload(), false);
}();
